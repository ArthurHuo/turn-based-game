...
public class CreateNewEquipment : MonoBehaviour {
	...
	private string[] itemDescritions = new string[2]{"A new cool item","A new not-so-cool item"};
	...
	private void CreateEquipment(){
		...
		ChooseItemType ();
		newEquipment.ItemDescription = itemDescritions [Random.Range (0, itemDescritions.Length)];
